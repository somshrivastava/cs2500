...
(define (draw-neighborhood-commuters combination scale)
  (overlay
   (square
    (* scale (* 15 (/ (neighborhood-commuters-commuters combination) 1000)))
    "solid"
    (get-neighborhood-color (neighborhood-commuters-commuters combination)))
   (square (* scale 300) "outline" "black")))

;; Test Cases
(check-expect (draw-neighborhood-commuters HYDE-PARK-NEIGHBORHOOD-COMMUTERS 0.5)
              (overlay
               (square
                (* 0.5 (* 15 (/ (neighborhood-commuters-commuters HYDE-PARK-NEIGHBORHOOD-COMMUTERS) 1000)))
                "solid"
                (get-neighborhood-color (neighborhood-commuters-commuters HYDE-PARK-NEIGHBORHOOD-COMMUTERS)))
               (square (* 0.5 300) "outline" "black")))
(check-expect (draw-neighborhood-commuters EAST-BOSTON-NEIGHBORHOOD-COMMUTERS 1)
              (overlay
               (square
                (* 1 (* 15 (/ (neighborhood-commuters-commuters EAST-BOSTON-NEIGHBORHOOD-COMMUTERS) 1000)))
                "solid"
                (get-neighborhood-color (neighborhood-commuters-commuters EAST-BOSTON-NEIGHBORHOOD-COMMUTERS)))
               (square (* 1 300) "outline" "black")))
(check-expect (draw-neighborhood-commuters BRIGHTON-NEIGHBORHOOD-COMMUTERS 0.7)
              (overlay
               (square
                (* 0.7 (* 15 (/ (neighborhood-commuters-commuters BRIGHTON-NEIGHBORHOOD-COMMUTERS) 1000)))
                "solid"
                (get-neighborhood-color (neighborhood-commuters-commuters BRIGHTON-NEIGHBORHOOD-COMMUTERS)))
