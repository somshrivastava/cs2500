...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 10-9-position) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; - '()
;; - (cons Position LoP)
;;represents a list of positions with x and y coordinates

(define LOP-0 '())
(define LOP-2 (cons POSN-1 (cons POSN-2 (cons POSN-3 LOP-0))))
